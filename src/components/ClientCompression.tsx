    ...
    return (
        <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <input 
                ...
                className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer" 
            />
            ...
            {originalPreview && compressedPreview && !compressing &&(
                <div className="mt-6 grid md:grid-cols-2 gap-6">
                    <div className="border rounded-lg p-4">
                        <h3 className="font-semibold mb-3 text-black">Original</h3>
                    ...
                    <div className="border rounded-lg p-4">
                        <h3 className="font-semibold mb-3 text-black">Compressed</h3>
